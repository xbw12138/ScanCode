...
package com.xbw.scancode.scanner.camera;
 ...
 * <br/>
 * 
 * 璇ョ被灏佽浜嗙浉鏈虹殑鎵�鏈夋湇鍔″苟涓旀槸璇pp涓敮涓�涓庣浉鏈烘墦浜ら亾鐨勭被
 * 
...
public final class CameraManager {
	 ...
	 * 
	 * 涓や釜缁戝畾鎿嶄綔锛�<br/>
	 * 1锛氬皢handler涓庡洖璋冨嚱鏁扮粦瀹氾紱<br/>
	 * 2锛氬皢鐩告満涓庡洖璋冨嚱鏁扮粦瀹�<br/>
	 * 缁间笂锛岃鍑芥暟鐨勪綔鐢ㄦ槸褰撶浉鏈虹殑棰勮鐣岄潰鍑嗗灏辩华鍚庡氨浼氳皟鐢╤ander鍚戝叾鍙戦�佷紶鍏ョ殑message
	 * 
	 * @param handler
	...
	public synchronized void requestPreviewFrame(Handler handler, int message) {
		...
		if (theCamera != null && previewing) {
			...
			// 缁戝畾鐩告満鍥炶皟鍑芥暟锛屽綋棰勮鐣岄潰鍑嗗灏辩华鍚庝細鍥炶皟Camera.PreviewCallback.onPreviewFrame
